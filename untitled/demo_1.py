...
# 向账号输入框内输入手机号
# dr.find_element_by_id('com.qk.butterfly:id/et_login_phone').send_ke
# \ys('15638292964')
# 向密码输入框内输入密码
...
#
#         # 获取微信文字nd
#         text = self.dr.find_element_by_id('com.qk.butterfly:id/v_login_wx').find_element_by_class_name('aroid.widget.TextView').text
#         print(text)
#         return text
#
#     # 关闭app的函数
